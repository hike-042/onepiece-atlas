/* ============================================================
   ...
   { id, name, locationId, kind: "history" | "road" | "master",
     color: "black" | "red", status, summary: one original sentence }
   ============================================================ */

export const PONEGLYPHS = [
  { id:"shandora", name:"Shandora Poneglyph", locationId:"skypiea", kind:"history", color:"black", status:"intact",
  ...
  { id:"alabasta-tomb", name:"Alubarna Royal Tomb Poneglyph", locationId:"alabasta", kind:"history", color:"black", status:"destroyed",
  ...
  { id:"zou-back", name:"Zunesha's Back Poneglyph", locationId:"zou", kind:"road", color:"black", status:"intact",
  ...
  { id:"whole-cake", name:"Whole Cake Island Poneglyph", locationId:"wholecake", kind:"road", color:"black", status:"intact",
    summary:"One of the four Road Poneglyphs, its location and text already memorized by Charlotte Pudding, who was born with the rare ability to read the script by sight." },
  { id:"wano-onigashima", name:"Onigashima Poneglyph", locationId:"wano", kind:"road", color:"black", status:"intact",
  ...
  { id:"rio-poneglyph", name:"Rio Poneglyph", locationId:"fishmanisland", kind:"master", color:"red", status:"intact",
    summary:"Hidden in Fish-Man Island's Sea Forest and carved in a distinct reddish stone, the master tablet that records the true history in full and reveals Laugh Tale's location once read alongside the Road Poneglyphs." },
];
